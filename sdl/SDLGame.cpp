...
bool SDLGame::init()
{
    ...
    else
    {
       ...
       // resolution for mac os x
        ...
        m_pWindow = SDL_CreateWindow( m_sdlGameConfigs.windowTitle.c_str(), SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, m_pScreenRect->w, m_pScreenRect->h, windowFlags);
        if( m_pWindow == NULL )
        {
        ...
        else
        {
            ...
            // update screen size
            SDL_GetRendererOutputSize(m_pRenderer, &m_pScreenRect->w, &m_pScreenRect->h);
    ...
    else
    {
        ...
        while(!quit)
        {
            ...
            SDL_SetRenderDrawColor(m_pRenderer, 
                m_sdlGameConfigs.backgroundColor.r,

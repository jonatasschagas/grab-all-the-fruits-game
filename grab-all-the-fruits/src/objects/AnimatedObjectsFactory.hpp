...
private:
    ...
    AnimatedObject* createObstacle(const int tileX, const int tileY, const string& objectName, const string& objectType, Vector2 position, Vector2 size, const TileConfig* pTileConfig);
